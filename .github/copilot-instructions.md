...
This is a Laravel package that generates Eloquent models and factories from existing database schemas, supporting MySQL, PostgreSQL, and SQLite databases.
...
- Validate namespaces: `php artisan wink:validate-namespaces`
...
- Add PHPDoc blocks for public methods with `@param` and `@return` tags
- Use dependency injection over facades where possible
- Write tests for new functionality using PHPUnit
